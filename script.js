...
function setup() {
  ...
  // Define button area size and position
  let buttonContainer = select('#button-container');
  buttonArea.x = buttonContainer.elt.offsetLeft;
  buttonArea.y = buttonContainer.elt.offsetTop;
  buttonArea.width = buttonContainer.elt.clientWidth;
  buttonArea.height = buttonContainer.elt.clientHeight;

  // Fade in buttons after canvas is loaded
